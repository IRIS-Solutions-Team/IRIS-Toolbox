...
lookupTable = {
    ...
    'Behavior:InvalidDotAssign', 'This is not valid behavior for InvalidDotAssign: %s'
    ...
    'Model:InvalidQuantityType', 'This is not a valid type of model quantities: %s'
    ...
    'Model:TrollifyInvalidName', 'Cannot trollify model because this name is not alllowed in TROLL/FAME: %s'
    'Model:UnknownInputData', 'Invalid format of input data.'
    'Model:ZeroVarianceFactor', 'Common variance factor estimate is zero because all observations match their one-step-ahead predictions; run Kalman filter with Relative=false instead: %s '
    ...
    'TheParser:InconsistentAllBut', 'The keyword !all_but may be used in either all or none of the !log_variables declaration blocks.'
    ...
    'TheParser:InvalidLogNameDeclared', 'This name cannot be declared as log-variable: %s '
