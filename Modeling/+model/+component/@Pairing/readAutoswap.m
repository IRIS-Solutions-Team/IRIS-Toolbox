...
if any(ix)
    lsExog = puc.Lhs(ix);
    lsEndog = puc.Rhs(ix);
    autoswap.Simulate = model.component.Pairing.setAutoswap( autoswap.Simulate, 'Dynamic', ...
...
if any(ix)
    lsExog = puc.Lhs(ix);
    lsEndog = puc.Rhs(ix);
    autoswap.Steady = model.component.Pairing.setAutoswap( autoswap.Steady, 'Steady', ...
                                                           quantity, lsExog, lsEndog );
end
