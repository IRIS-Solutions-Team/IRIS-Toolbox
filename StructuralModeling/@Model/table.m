...
for n = requests
    ...
    elseif strcmpi(n, 'Kind')
        addTable = tableKind(this);
...
function addTable = tableKind(this)
    numQuantities = numel(this.Quantity.Name);
    type = reshape(this.Quantity.Type, 1, []);
    values = repmat("", numQuantities, 1);
    values(type==1) = "measurement-variable";
    values(type==2) = "transition-variable";
    values(type==31) = "measurement-shock";
    values(type==32) = "transition-shock";
    values(type==4) = "parameter";
    values(type==5) = "exogenous-variable";
    addTable = tableTopic(this, {'Kind'}, [], values);
end%
