function [asgndQty, asgndStdCorr] = assigned(this, variantsRequested)
...
asgndQty = this.Variant.Values(:, :, variantsRequested);
if nargout>1
    asgndStdCorr = this.Variant.StdCorr(:, :, variantsRequested);
end
